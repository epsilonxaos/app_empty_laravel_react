...
@section('content')
    <div class="relative overflow-x-auto">
        <div class="flex items-center justify-end pb-4 bg-white dark:bg-gray-900">
            <a href="{{route('panel.usuarios.create')}}" class="text-white bg-emerald-700 hover:bg-emerald-800 rounded-lg px-3 py-2 text-xs font-medium dark:bg-emerald-600 dark:hover:bg-emerald-700 flex items-center">
            ...
            <tbody>
                @foreach ($user as $item)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <a href="#" class="font-medium text-blue-600 dark:text-blue-500 "><svg class="w-5 inline" aria-hidden="true"
                            ...
                            <a href="#" class="font-medium text-red-600 dark:text-red-500 ml-2"><svg class="w-5 inline" aria-hidden="true"
                                    fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
